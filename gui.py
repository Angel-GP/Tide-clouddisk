...
DEFAULT_TEXTS = {
    ...
    "batch_download": "下载所选", "batch_delete": "删除所选", "batch_selected": "已选 {n} 项",
...
TEXT_GROUPS = [
    ...
    ("文件列表页", ["refresh", "btn_upload", "btn_view_list", "btn_view_browse", "badge_public",
                    "btn_batch", "btn_batch_exit", "batch_download", "batch_delete", "batch_selected",
                    "batch_confirm_delete", "batch_delete_result",
