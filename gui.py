...
DEFAULT_TEXTS = {
    ...
    "btn_batch": "批量管理", "btn_batch_exit": "退出选择",
    "batch_download": "下载所选", "batch_delete": "删除所选", "batch_hide": "隐藏所选", "batch_selected": "已选 {n} 项",
    "batch_confirm_delete": "确定删除选中的 {n} 项吗? 此操作不可恢复!",
    "batch_delete_result": "批量删除完成: 成功 {n} 项, 失败 {m} 项",
    "batch_hide_result": "批量隐藏完成: 成功 {n} 项, 失败 {m} 项",
...
TEXT_GROUPS = [
    ...
    ("文件列表页", ["refresh", "btn_upload", "btn_view_list", "btn_view_browse", "badge_public",
                    "btn_batch", "btn_batch_exit", "batch_download", "batch_delete", "batch_hide", "batch_selected",
                    "batch_confirm_delete", "batch_delete_result", "batch_hide_result",
...
def _main():
    ...
    try:
        ...
        pass
    # 窗口图标 (Tk 默认是羽毛; 优先使用程序目录下的 app.ico, 不存在则保持默认)
